package com.example.springbootsocketio.service;
...
import com.example.springbootsocketio.ClientInfo;
import com.example.springbootsocketio.MessageInfo;
import com.example.springbootsocketio.SocketIoServerMapUtil;
...
public class MessageEventHandler {
    ...
    public void onConnect(SocketIOClient client) {
        ...
        SocketIoServerMapUtil.put(clientId, client);
    }
    ...
    public void onDisconnect(SocketIOClient client) {
        ...
        SocketIoServerMapUtil.remove(clientId);
        //在线数减1
